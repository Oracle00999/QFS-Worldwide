    ...
    <section className="relative py-20 md:py-28 bg-[#0B1F3A] border-t border-[#112E4A]">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(circle at 25% 25%, #2F8CFF 1px, transparent 1px)`,
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#0B1F3A] via-transparent to-[#0B1F3A] opacity-80"></div>
      <div className="absolute top-1/2 left-0 right-0 h-96 bg-gradient-to-r from-[#2F8CFF]/10 via-[#1EC9E8]/5 to-[#2F8CFF]/10 transform -translate-y-1/2"></div>
            ...
            <div className="space-y-6 text-lg text-[#D1D9E0]">
              ...
              <div className="mt-8 pt-8 border-t border-[#163E63] relative">
                ...
                <blockquote className="text-xl font-medium italic text-white text-center px-4">
                  ...
                  economy for every American and every global citizen."
                </blockquote>
                ...
                <div className="bg-[#112E4A] rounded-xl p-4 border border-[#163E63] hover:border-[#F5B400] transition-colors duration-300">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[#7FA6C9]">Protected</div>
                    </div>
                  </div>
                </div>
              </div>
